...
public class RESTFullClient {
	...
	public void getData(){
		...
		get.getDataWithOutParm("http://localhost:8080/spring-restfull/getData");
		...
		req.setType(22);
		post.getDataWithParm("http://localhost:8080/spring-restfull/getDataParm", req);
		
		PutMethodAction put = new PutMethodAction();
		put.putDataWithParm("http://localhost:8080/spring-restfull/putDataParm", req);
	...
	public void test1(HttpClient httpclient){
		try {
			HttpGet httpget = new HttpGet("http://localhost:8080/spring-restfull/getData");
